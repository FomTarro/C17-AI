	...
	function getMoveActions(ourMon, theirMon){
		...
		//console.log("OurMon moves number: " + moves.length);
		...
		console.log("Length of actions: " + posActions.length);
		console.log("Our mon moves:");
		console.log(ourMon.moves);
	...
	function outDamage(move, target){
		...
		move = move.toLowerCase().replace(/60/gm, '').replace(/ /gm, '').replace(/-/gm, '');
